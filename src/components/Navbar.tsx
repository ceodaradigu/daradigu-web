...
import { FiHome, FiEdit, FiZap, FiFolder } from 'react-icons/fi';
    ...
    <aside className="w-60 min-h-screen bg-gradient-to-br from-[#0A0A0F] via-[#14142A] to-[#1A1A3F] text-white p-6 flex flex-col justify-between shadow-xl">
      <div>
        <div className="flex justify-center mb-12">
          <h2 className="text-3xl font-extrabold bg-gradient-to-r from-[#00FFFF] via-[#FF00FF] to-[#FF0070] bg-clip-text text-transparent tracking-wide">
            DARADIGU IA
          </h2>
        </div>
